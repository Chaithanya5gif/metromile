...
const s = StyleSheet.create({
  ...
  pageTitle: {color: '#f8fafc', fontSize: 24, fontWeight: '800', padding: 20, paddingBottom: 8},
  heroCard: {
    marginHorizontal: 16,
  ...
  heroLabel: {color: '#6ee7b7', fontSize: 13, fontWeight: '600'},
  ...
  heroPill: {backgroundColor: '#065f46', borderRadius: 20, paddingHorizontal: 14, paddingVertical: 6},
  heroPillText: {color: '#6ee7b7', fontSize: 12, fontWeight: '600'},
  statsGrid: {
    flexDirection: 'row',
  ...
  statPeriod: {color: '#64748b', fontSize: 11, fontWeight: '600', marginBottom: 4},
  statAmt: {color: '#10b981', fontSize: 18, fontWeight: '800'},
  sectionTitle: {color: '#f8fafc', fontSize: 18, fontWeight: '700', paddingHorizontal: 16, marginBottom: 12},
  tipCard: {
    marginHorizontal: 16,
    backgroundColor: '#1e293b',
    borderRadius: 16,
  ...
  tipIcon: {fontSize: 28},
  tipBody: {flex: 1},
  tipLabel: {color: '#f8fafc', fontSize: 14, fontWeight: '700'},
  tipTime: {color: '#64748b', fontSize: 12, marginTop: 2},
